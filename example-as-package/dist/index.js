...
$button1.addEventListener('click', () => {
    const calc = new package1__WEBPACK_IMPORTED_MODULE_0__.Calc({ value: 1 });
    calc.add(new package1__WEBPACK_IMPORTED_MODULE_0__.Item({ value1: 2, value2: 3 }));
    calc.add(new package1__WEBPACK_IMPORTED_MODULE_0__.Item({ value1: 5, value2: 9 }));
